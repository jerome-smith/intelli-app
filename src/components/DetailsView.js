    ...
    return (
      <ScrollView showsVerticalScrollIndicator={false}>
       ...
       <TouchableOpacity style={styles.closeIcon}
        ...
        >
            <Image
                source={require('../images/close@2x.png')}
                />
       </TouchableOpacity>
        <Text style={[theme.cardTitleStyle, styles.title1]}>{this.props.person.first_name} {this.props.person.last_name}</Text>
        <Text style={[theme.cardTitleStyle, styles.title2]}>{this.props.person.company} bank details</Text>
        ...
        <View style={styles.textArea}>
           ...
           <Text style={theme.cardContentStyle}>{this.props.person.bankname}</Text>
        </View>
        <View style={styles.textArea}>
